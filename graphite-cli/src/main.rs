...
"#;
    ...
    // Create src/lib.rs
    let lib_rs = r#"//! Subgraph handlers — generated by `graphite init`.
//!
...
mod generated;
use generated::{ExampleEntity, TransferEvent};
...
#[handler]
pub fn handle_transfer(event: &TransferEvent, _ctx: &graphite::EventContext) {
    let id = format!(
        "{}-{}",
...
mod tests {
    ...
    fn transfer_creates_entity() {
        ...
        handle_transfer_impl(
            &TransferEvent::from_raw_event(&mock_transfer_event()).unwrap(),
